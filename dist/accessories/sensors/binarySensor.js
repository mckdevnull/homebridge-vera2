    ...
    setupServices() {
        ...
        switch (this.device.kind) {
            case DeviceKind.ContactSensor:
                ...
                this.valueFor = (t) => t ? C.ContactSensorState.CONTACT_NOT_DETECTED : C.ContactSensorState.CONTACT_DETECTED;
                break;
            ...
            case DeviceKind.CoSensor:
                ...
                this.valueFor = (t) => t ? C.CarbonMonoxideDetected.CO_LEVELS_ABNORMAL : C.CarbonMonoxideDetected.CO_LEVELS_NORMAL;
                break;
