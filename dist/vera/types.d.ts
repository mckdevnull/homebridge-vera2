 ...
 */
export declare class TypedEmitter<M extends Record<string, unknown[]>> extends EventEmitter {
    on<K extends keyof M & string>(event: K, listener: (...args: M[K]) => void): this;
    once<K extends keyof M & string>(event: K, listener: (...args: M[K]) => void): this;
